...
- [ ] T050 [P] Add comprehensive error handling and structured logging
...
- [ ] T056 Implement `cache` subcommand in `src/license_tracker/cli.py`
  - `cache show` - display cache location, entry count, size
  - `cache clear` - clear all cached entries
  - `cache clear <package>` - clear specific package cache
