...
- **FR-1.1**: System MUST implement a Scanner interface for extracting dependency names and versions from multiple sources
...
- **NFR-3**: System MUST implement local cache (`~/.cache/license_tracker/`) for resolved license URLs
